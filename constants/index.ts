...
const TEAM_MEMBERS = [
  {
    name: "Gagan Gowda",
    bio: "With vast experience, Gagan drives Karang’s growth—balancing marketing impact with flawless execution.”",
  },
  {
    name: "Keerthi Nagaraj",
    bio: "Money, HR care, and seamless service delivery---Keerthi keeps Karang steady and strong",
  },
  {
    name: "Navya Nagaraj",
    bio: "Digital Marketing & Tech Specialist Helping brands grow with smart digital marketing and seamless technical support.",
  },
];
